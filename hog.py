...
def roll_dice(num_rolls, dice=six_sided):
    ...
    scores = [dice() for _ in range(num_rolls)]
...
def is_swap(score0, score1):
    ...
    if score0 <= 1 or score1 <= 1:
        ...
        return max(score0, score1) % min(score0, score1) == 0
...
def make_averaged(fn, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 8
    def make_averaged_result(*args):
       summ = 0
       for _ in range(num_samples):
          summ += fn(*args)
       return summ / num_samples
    return make_averaged_result
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    #BEGIN PROBLEM 9
    optimal_num_rolls = 10
    max_average = 0
    for i in range(1,11):
        make_average = make_averaged(roll_dice,num_samples)
        if make_average(i,dice) > max_average:
            max_average = make_average(i,dice)
            optimal_num_rolls = i
        #new_max_average = make_averaged(roll_dice(i,dice),num_samples)
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    return 0 if free_bacon(opponent_score) >= margin or  is_swap(score,opponent_score) else num_rolls   # Replace this statement
    # END PROBLEM 11
